...
namespace sengokugifu
{
	internal class RequestHandler : IRequestHandler {
		...
		public bool OnResourceResponse(IWebBrowser browserControl, IBrowser browser, IFrame frame, IRequest request, IResponse response) {
		   ...
		   //
           //if (request.Url.Contains("http://gamefront.sengokugifu.jp/pay.php"))
           //{
           //    System.Diagnostics.Process.Start("chrome.exe", request.Url);
           //    // System.Diagnostics.Process.Start("https://www.0718.work/");
           //    return false;
           //}
           //else if (request.Url.Contains("http://secure.lionsfilm.co.jp/vg/shop"))
           //{
           //    System.Diagnostics.Process.Start("chrome.exe", request.Url);
           //    return false;
           //}
            //else if (request.Url.Contains("baidu.com"))
            //{
            //    System.Diagnostics.Process.Start("chrome.exe", request.Url);
            //    return false;
            //}
            ...
            //		request.Url = sengokugifu.FileNotFoundURL + "?path=" + request.Url.EncodeURL();
            //	}
